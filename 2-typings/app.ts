...
const ONE_BILLION: number = 1_000_000_000;           //         1.000.000.000 (9)
const ONE_TRILLION: number = 1_000_000_000_000;       //     1.000.000.000.000 (12)
const ONE_QUADRILLION: number = 1_000_000_000_000_000; // 1.000.000.000.000.000 (15)
const MAX: number = 9_007_199_254_740_992;             // 9.007.199.254.740.992 (15)
